---
tags: [pitch, livrable-4, sprint-4]
statut: en-cours
sprint: 4
priorité: haute
---
...
```mermaid
pie title Répartition du pitch (7 min)
    "Problème (1:00)": 60
    "Solution (1:30)": 90
    "Démo produit (1:00)": 60
    "Marché & concurrence (1:00)": 60
    "Business model (1:00)": 60
    "Équipe & roadmap (0:45)": 45
    "Ask & conclusion (0:45)": 45
```
